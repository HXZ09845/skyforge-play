...
每次首领完成一轮弹幕后，核心会短暂变成青色并显示「核心破防」。窗口约 0.9 秒，命中核心期间伤害提高 65%；错过窗口就要先躲过下一轮攻击。手机和电脑共用同一套提示，不增加额外按键。
...
从第二关起，第 2、3 波的最后一架敌机有 70% 概率升级为精英目标：体型更大、耐久约为普通敌机的 1.8 倍，近战伤害更高，并以金色血条标记。击败精英目标获得 250 分、2 点超载能量，并必定掉落射速道具，适合在风险更高时追求高分；不击破也不会阻塞波次。
